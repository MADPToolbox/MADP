...
#ifndef _BGIP_SOLVERBFSNONINCREMENTAL_H_
#define _BGIP_SOLVERBFSNONINCREMENTAL_H_ 1
...
/**\brief BGIP_SolverBFSNonIncremental is a class that performs Brute
 ...
 */
template<class JP>
class BGIP_SolverBFSNonIncremental : public BayesianGameIdenticalPayoffSolver_T<JP>
{
private:    
...
public:
     ...
     * of the proper shape.*/
    BGIP_SolverBFSNonIncremental(const boost::shared_ptr<const BayesianGameIdenticalPayoffInterface> &bg,
        ...
        while(!round)
        {
            ...
            if(_m_deadlineInSeconds && (i % checkPointForDeadline) == 0)
            {
                ...
                else
                {
                    ...
                    {
                        std::stringstream ss;
                        ss << "BGIP_SolverBFSNonIncremental::Solve after " 
...
#endif /* !_BGIP_SOLVERBFSNONINCREMENTAL_H_ */
