...
#ifndef _MDPPOLICYITERATIONGPU_H_
#define _MDPPOLICYITERATIONGPU_H_ 1
...
/**\brief MDPPolicyIterationGPU implements policy iteration for MDPs via GPU.
  */
class MDPPolicyIterationGPU : public MDPSolver,
