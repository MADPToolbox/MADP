...
typedef boost::shared_ptr<PolicyPoolInterface> PolicyPoolInterface_sharedPtr;
...
class PolicyPoolInterface 
{
    ...
    public:
         ...
         */
        virtual PolicyPoolItemInterface_sharedPtr Select()const=0;        
         ...
         */
        virtual PolicyPoolItemInterface_sharedPtr GetBestRanked() const=0;
